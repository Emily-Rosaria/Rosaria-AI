...
module.exports = {
    ...
    execute(message, args) {
      ...
      if (args.length > 0) {
        ...
        return message.reply(`Use this command to update your introduction stored in the bot! For example, \`$setintro Hiya! I'm Emily and I'm...\`. It can then be accessed through the \`$intro\` command.`);
      }
    },
};
