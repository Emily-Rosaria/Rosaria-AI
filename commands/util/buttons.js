...
module.exports = {
    ...
    description: 'Have the bot make post buttons, which either link to a page or send a note message when pushed. On-click actions are only visible to button clickers. Arguments for each button should be posted on a seperate line.', // The description of the command (for help text)
